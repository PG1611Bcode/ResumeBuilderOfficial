        ...
        <div class="grid">
            ...
            <ul>
              ${strengths.map(s => `
                <li style="margin-bottom: 12px;">
                  ${s?.point ? `<strong>${s.point}</strong><br><span style="font-size: 13px; color: #4b5563;">${s.detail}</span>` : (s || '')}
                </li>
              `).join('')}
            </ul>
          </div>
          ...
          <div class="box weaknesses-box">
            ...
            <ul>
              ${weaknesses.map(w => `
                <li style="margin-bottom: 12px;">
                  ${w?.point ? `<strong>${w.point}</strong><br><span style="font-size: 13px; color: #4b5563;">${w.detail}</span>` : (w || '')}
                  ${w?.actionableStep ? `<br><div style="margin-top: 4px; padding: 6px; background: #fee2e2; border-left: 2px solid #ef4444; font-size: 12px; color: #991b1b;">💡 ${w.actionableStep}</div>` : ''}
                </li>
              `).join('')}
            </ul>
          </div>
